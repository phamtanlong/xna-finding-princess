...
{
    class CBaseBrick : CObject
    {
        public CBaseBrick(IDObject _ID, float _PosX, float _PosY)
        ...
        {
            m_CurSprite = new CSprite(CResourceManager.getInstance().getSprite(IDResource.BaseBrick));

...
namespace FindingPrincess.Framework
{
    class Node
    {
        ...
        public bool AddObject(CObject _obj)
        {
            ...
            if (!this._bound.Intersects(_obj.getBoundingBox()))
            {
                ////Console.WriteLine("CanNOTNOTNOTNOTNOTNOTNOTNOTNOTNO add..........");
                return false;
            }
            ...
            {//////////////////////Có thể chia ra Node con nữa ///////////////////////
                ...
                for (int i = 0; i < 4; ++i)
                {
                    if (_listChildNode[i].Bound.Intersects(_obj.getBoundingBox()))
                        countCollision++;
                }
        ...
        public bool RemoveObject(CObject _obj)
        {
            if (_listObject.Contains(_obj))
            {
                ...
                ////Console.WriteLine("Remove............MOVE...........MOVE............MOVE");
                return true;
            }
            else
            {
        ...
        public List<CObject> GetObjects(Rectangle _camera)
        {
            ...
            {///////////////////////////// Có va chạm camera ///////////////////////////
                ...
                {///////////////////////// không có Node con ///////////////////////////
                    ...
                    {
                        if (_listObject[i].getBoundingBox().Intersects(_camera))

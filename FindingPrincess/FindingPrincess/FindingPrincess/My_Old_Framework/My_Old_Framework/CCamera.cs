...
namespace FindingPrincess.Framework
{
    class CCamera
    {
        ...
        public void Update(CObject _Obj, GraphicsDevice graphics)
        {
            if (_Obj.Position.X > graphics.Viewport.Width / 2)
            {
        ...
        {
            m_Transform = Matrix.Identity * Matrix.CreateTranslation(new Vector3(-m_Pos.X, -m_Pos.Y, 0)) * Matrix.CreateTranslation(new Vector3(400, 300, 0));
        ...
        public void UnLoad()
        {
            Console.WriteLine("UnLoad content of Camera......");
        }
    }
}
